...
for i in range(1, n + 1):
    list_crop.append(int(input(f"введите количество ягод на кусте {i}: ")))


max_crop = list_crop[0] + list_crop[1] + list_crop[2]

for i in range(2, n - 1):
    if list_crop[i - 1] + list_crop[i] + list_crop[i + 1] > max_crop:
        max_crop = list_crop[i - 1] + list_crop[i] + list_crop[i + 1]
